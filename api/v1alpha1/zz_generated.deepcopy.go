...
func (in *FollowParams) DeepCopyInto(out *FollowParams) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FollowParams.
func (in *FollowParams) DeepCopy() *FollowParams {
	if in == nil {
		return nil
	}
